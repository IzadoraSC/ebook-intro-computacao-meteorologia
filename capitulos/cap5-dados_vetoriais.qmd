# Capítulo 5 – Dados Vetoriais com o pacote `geobr` e integração com dados meteorológicos
...
## 2. Instalando e carregando o pacote `geobr`
...
## ️3. Carregando dados geográficos
...
## 5. Mapa temático com precipitação
...
::: {.callout-tip icon="pencil" title="Agora pratique!"}
